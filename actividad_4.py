...
def download_files():
    ...
    for each in selected_items2:
        ...
        if selected_file['.tag'] == 'file':
            ...
            destination_path = selected_file['name']
...
button2 = tk.Button(frame2, borderwidth=4,  background="#f696af",fg="white", text="Delete", width=10, pady=8, command=delete_files)
button2.pack(padx=2, pady=2)
button3 = tk.Button(frame2, borderwidth=4, background="#aa77c3",fg="white", text="Create folder", width=10, pady=8, command=create_folder)
button3.pack(padx=2, pady=2)
button4 = tk.Button(frame2, borderwidth=4, background="#5d58d7",fg="white", text="Move file", width=10, pady=8, command=move_file)
button4.pack(padx=2, pady=2)
button5 = tk.Button(frame2, borderwidth=4, background="#6165c2",fg="white", text="Rename file", width=10, pady=8, command=rename_file)
button5.pack(padx=2, pady=2)
button6 = tk.Button(frame2, borderwidth=4, background="#6571ac",fg="white", text="Download file", width=10, pady=8, command=download_files)
button6.pack(padx=2, pady=2)
button7 = tk.Button(frame2, borderwidth=4, background="#7571c2",fg="white", text="Show metadata", width=10, pady=8, command=show_metadata)
